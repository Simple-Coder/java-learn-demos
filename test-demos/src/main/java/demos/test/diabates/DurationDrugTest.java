 ...
 */
public class DurationDrugTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/duration_drug.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/duration_drug1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("duration_drug");
            trainData.setText(ss2 + "疗效多久，持续时间？");
            trainData.setId(0l);
