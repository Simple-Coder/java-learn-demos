 ...
 */
public class PathogenesisDiseaseTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/pathogenesis_disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/pathogenesis_disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("pathogenesis_disease");
            trainData.setText(ss2 + "发病机制是什么？");
            trainData.setId(0l);
