 ...
 */
public class TestItemDiseaseTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/test_item_disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/test_item_disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("test_items_disease");
            trainData.setText(ss2 + "有哪些检查指标可参考？");
            trainData.setId(0l);
