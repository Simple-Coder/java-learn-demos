 ...
 */
public class TreatmentDiseaseTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/Treatment_Disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/Treatment_Disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("treatment_disease");
            trainData.setText(ss2 + "有哪些不吃药的治疗方法？");
            trainData.setId(0l);
