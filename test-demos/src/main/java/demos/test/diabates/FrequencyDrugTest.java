 ...
 */
public class FrequencyDrugTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/frequency_drug.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/frequency_drug1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("frequency_drug");
            trainData.setText(ss2 + "用药频率是怎样呢？一天吃几次？");
            trainData.setId(0l);
