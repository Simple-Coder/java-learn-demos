 ...
 */
public class DrugMethodTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/drug_method.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/drug_method.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("drug_method");
            trainData.setText(ss2 + "的用药方法，用药方式是什么？");
            trainData.setId(0l);
