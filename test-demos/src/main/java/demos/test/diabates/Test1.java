...
//        Map<String, Object> ADE_Disease = MapUtil.filter(relsMap, entry -> entry.getValue().equals("ADE_Disease"));
//        System.out.println("发现不良反应->疾病：" + JSON.toJSONString(ADE_Disease));
    }
