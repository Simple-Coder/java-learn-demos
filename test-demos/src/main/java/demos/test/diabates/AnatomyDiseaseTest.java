...
/**
 * Created by xiedong
 * Date: 2023/5/11 22:01
 */
public class AnatomyDiseaseTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/anatomy_disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/anatomy_disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("anatomy_disease");
            trainData.setText(ss2 + "发病的部位是哪里？");
            trainData.setId(0l);
