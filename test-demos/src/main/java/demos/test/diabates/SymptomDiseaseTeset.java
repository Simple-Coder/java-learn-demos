 ...
 */
public class SymptomDiseaseTeset {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/symptom_disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/symptom_disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("symptom_disease");
            trainData.setText(ss2 + "的症状表现是怎样的呢，有哪些临床表现？");
            trainData.setId(0l);
