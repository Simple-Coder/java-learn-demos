...
/**
 * Created by xiedong
 * Date: 2023/5/11 21:38
 */
public class ClassDiseaseTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/class_disease.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/class_disease1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("class_disease");
            trainData.setText(ss2 + "有哪些分期类型？");
            trainData.setId(0l);
