 ...
 */
public class ADEDrugTest {
    public static void main(String[] args) {
        String path = "/Users/xiedong/IdeaProjects/java-learn-demos/ade_drug.json";
        String destiDataPath = "/Users/xiedong/IdeaProjects/java-learn-demos/ade_drug1.json";
...
//            String s2 = split.get(1);
            ...
            trainData.setIntent("ade_drug");
            trainData.setText(ss2 + "有哪些不良反应、副作用？");
            trainData.setId(0l);
